...
const phases = [
  ...
  },
  {
    id: 2,
    label: "FASE 2",
    title: "UI / UX / Pantallas",
    status: "pending",
    color: "#FFAA00",
    goal: "Set completo de pantallas + HUD portrait pulido, todo navegable",
    milestone: "✓ Un jugador nuevo recorre menu -> partida -> resultado -> rejugar sin ayuda",
    tasks: [
      {
        category: "Flujo de pantallas",
        items: [
          "Splash/boot -> Menu principal -> seleccion de modo",
          "Lobby / seleccion de rol -> seleccion de personaje",
          "HUD en partida -> resultado -> rematch / lobby",
          "Navegacion con back, transiciones, estados de carga",
          "Diseñadas network-ready (el lobby alojara salas/matchmaking despues)",
        ],
      },
      {
        category: "HUD de partida (portrait)",
        items: [
          "Re-layout vertical: joystick, botones de habilidad, ataque, timer, corazones",
          "UI del fantasma: puntero al cuerpo, boton de ping, prompt y barra de revive",
          "Indicadores de downed/aliados, casting bar, iconos de status effect",
        ],
      },
      {
        category: "Settings, pausa y UX",
        items: [
          "Pausa + settings (volumen Master/SFX/Music/Ambient via GameAudioMixer)",
          "Sensibilidad/posicion del joystick, accesibilidad basica",
          "Feedback: confirmaciones, tooltips de habilidad, juice de transiciones",
        ],
      },
    ],
  },
  ...
  },
  {
    ...
    status: "pending",
    color: "#00E09A",
    goal: "Arte final integrado, coherente, en portrait (inicio bloque comercial)",
...
const risks = [
  ...
  { label: "Portrait limita la lectura del mapa top-down", mitigation: "Validar framing/zoom de camara temprano en Fase 2.", severity: "media" },
